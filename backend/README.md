...
Chemin : http://127.0.0.1:8000/tickets/{id}     -     {id} étant l'id du ticket à mettre à jour
Valeurs attendues : Objet UpdateTicket avec la valeur de la priorité

Endpoint DELETE permettant la suppression d'un ticket :
Chemin : http://127.0.0.1:8000/tickets/{id}     -     {id} étant l'id du ticket à supprimer